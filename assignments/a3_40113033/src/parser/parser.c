...
int match(const char *type) {
  ...
  if (strcasecmp(lookahead->category, type) == 0) {
    ...
    if (strcmp("id", lookahead->category) == 0 ||
      ...
      create_leaf_node(lookahead->category, stack, lookahead->lexeme,
                       nodes_output);
    ...
    printf("lookahead token is now %s\n", lookahead->category);
    return true;
...
int parse(const char *path) {
  ...
  success = true;
  if (START()) { // If the parse found a valid sentence ...
    ...
    print_all_msgs(derivation_msg_stack, rule_output);
...
int START() {
  printf(
      "Calling START ... value of success %d ... value of lookahead %s ... \n",
      success, lookahead->category);
  if (!SkipErrors(first_start, follow_start, 4, 0, "START"))
    return false;
  if (in(first_prog, 4)) {

    node *prog = init_node("prog");
    push_node(prog, stack);
    print_stack(stack, stack_contents);
  ...
  printf(
      "Exiting START ... value of success %d ... value of lookahead %s... \n",
      success, lookahead->category);
  return success;
}
...
int PROG() {
  printf(
      "Calling PROG  ... value of success %d ... value of lookahead %s ... \n",
      success, lookahead->category);
  ...
  printf(
      "Exiting PROG ... value of success %d ... value of lookahead %s ... \n",
      success, lookahead->category);
...
int REPTPROG0() {
  printf("Calling REPTPROG0  ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTPROG0  ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int ADDOP() {
  printf(
      "Calling ADDOP  ... value of success %d ... value of lookahead %s ... \n",
      success, lookahead->category);
  ...
  printf(
      "EXITING ADDOP  ... value of success %d ... value of lookahead %s ... \n",
      success, lookahead->category);
 ...
 */
int APARAMS() {
  printf("Calling APARAMS  ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_expr, 7)) {
    ...
    push_node(init_node("$"), stack);
    print_stack(stack, stack_contents);

    updateDerivation(&derivation_string, "APARAMS", "EXPR REPT_APARAMS1");
    if (EXPR() & REPT_APARAMS1()) {

      node *aparamslist = create_subtree_pop_until("aparamslist", "$", stack);
      print_stack(stack, stack_contents);
      push_node(aparamslist, stack);
      print_stack(stack, stack_contents);
    ...
    push_node(init_node("aparams list"), stack);
    print_stack(stack, stack_contents);
  ...
  printf("Exiting APARAMS  ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int APARAMS_TAIL() {
  ...
  printf("Calling  APARAMS_TAIL  ... value of success %d ... value of "
         "lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting  APARAMS_TAIL  ... value of success %d ... value of "
         "lookahead %s "
         "... \n",
         success, lookahead->category);
...
int ARITHEXPR() {
  ...
  printf(
      "Calling  ARITHEXPR  ... value of success %d ... value of lookahead %s "
      "... \n",
      success, lookahead->category);
  ...
  printf(
      "Exiting  ARITHEXPR  ... value of success %d ... value of lookahead %s "
      "... \n",
      success, lookahead->category);
  return success;
}
...
int ARRAYSIZE() {
  ...
  printf(
      "Calling  ARRAYSIZE  ... value of success %d ... value of lookahead %s "
      "... \n",
      success, lookahead->category);
  ...
  printf(
      "Exiting  ARRAYSIZE  ... value of success %d ... value of lookahead %s "
      "... \n",
      success, lookahead->category);
 ...
 */
int FLSQBR() {
  printf("Calling  FSLQBR  ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting  FSLQBR  ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int ASSIGNOP() {
  ...
  printf("Calling ASSIGNOP ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting ASSIGNOP ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int EXPR() {
  ...
  printf("Calling EXPR ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting EXPR ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int OPTRELEXPR() {
  ...
  printf("calling OPTRELEXPR ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_relop, 6)) {
    ...
    if (RELOP() & ARITHEXPR()) {
      ...
      node *relexpr = create_subtree_n_nodes("relexper", 3, stack);
      push_node(relexpr, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting OPTRELEXPR ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int SIGN();
int FACTOR() {
  printf("calling FACTOR ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("id")) {
    ...
    if (match("not") & FACTOR()) {
      ...
      push_node(create_subtree_n_nodes("not", 1, stack), stack);
      print_stack(stack, stack_contents);
    ...
    if (SIGN() & FACTOR()) {
      ...
      push_node(create_subtree_n_nodes("sign", 2, stack), stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting FACTOR ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int FACTOR2() {
  printf("Calling FACTOR2 ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("lpar")) {
    ...
    if (match("lpar") & APARAMS() & match("rpar")) {
      ...
      node *funccall = create_subtree_n_nodes("funccall", 2, stack);
      print_stack(stack, stack_contents);
      push_node(funccall, stack);
    ...
    if (REPTIDNEST1()) {
      ...
      node *dimlist = create_subtree_pop_until("dimlist", "$", stack);
      push_node(dimlist, stack);
      print_stack(stack, stack_contents);

      node *var = create_subtree_n_nodes("var", 2, stack);
      push_node(var, stack);
      print_stack(stack, stack_contents);
    ...
    push_node(create_subtree_n_nodes("var", 2, stack), stack);
    print_stack(stack, stack_contents);
  ...
  printf("Exiting FACTOR2 ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int REPTFPARAMS4();
int FPARAMS() {
  printf("Calling FPARAMS ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("id")) {
    ...
    if (match("id") & match("colon") & TYPE()) {
      ...
      if (REPTFPARAMS3()) {
        ...
        push_node(create_subtree_pop_until("arraydims", "$", stack), stack);
        print_stack(stack, stack_contents);
        push_node(create_subtree_n_nodes("fparam", 3, stack), stack);
        print_stack(stack, stack_contents);

        if (REPTFPARAMS4()) {

          push_node(create_subtree_pop_until("fparams list", "$", stack),
                    stack);
          print_stack(stack, stack_contents);
    ...
    push_node(init_node("fparams list"), stack);
    print_stack(stack, stack_contents);
  ...
  printf("Exiting FPARAMS ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int FPARAMSTAIL() {
  ...
  printf(
      "Exiting FPARAMSTAIL ... value of success %d ... value of lookahead %s "
      "... \n",
      success, lookahead->category);
...
int FUNCBODY() {
  ...
  printf(
      "Calling FPARAMSTAIL ... value of success %d ... value of lookahead %s "
      "... \n",
      success, lookahead->category);
  ...
  if (compare("lcubr")) {
    ...
    if (match("lcubr") & REPTFUNCBODY1() & match("rcubr")) {
      ...
      node *funcbody = create_subtree_pop_until("funcbody", "$", stack);
      print_stack(stack, stack_contents);

      push_node(funcbody, stack);
      print_stack(stack, stack_contents);
...
int FUNCHEAD();
int FUNCDECL() {
  printf("Calling FUNCDECL ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting FUNCDECL ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
}
...
int FUNCDEF() {
  ...
  printf("Calling FUNCDEF ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_funchead, 1)) {
    ...
    if (FUNCHEAD() & FUNCBODY()) {
      ...
      node *funcdef = create_subtree_n_nodes("funcdef", 4, stack);
      print_stack(stack, stack_contents);
      push_node(funcdef, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting FUNCDEF ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
}
...
int FUNCHEAD() {
  ...
  printf("Calling FUNCHEAD ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting FUNCHEAD ... value of success %d ... value of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
}
...
int REPTVARIABLEORFUNCTIONCALL() {
  ...
  printf("Calling REPTVARIABLEORFUNCTIONCALL ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_idnest, 1)) {
    ...
    if (IDNEST() & REPTVARIABLEORFUNCTIONCALL()) {
      ...
      node *temp = create_subtree_n_nodes("dot", 2, stack);
      print_stack(stack, stack_contents);
      push_node(temp, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting REPTVARIABLEORFUNCTIONCALL ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int IDNEST() {
  printf("Calling IDNEST ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting IDNEST ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int IDNEST2() {
  printf("Calling IDNEST2 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting IDNEST2 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int IMPLDEF() {
  ...
  printf("Calling IMPLDEF ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("impl")) {
    ...
    if (match("impl") & match("id") & match("lcubr") & REPTIMPLDEF3() &
      ...
      node *impl = create_subtree_pop_until("impl", "$", stack);
      print_stack(stack, stack_contents);
      push_node(impl, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting IMPLDEF ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int INDICE() {
  printf("Calling INDICE ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting INDICE ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int MEMBERDECL() {
  ...
  printf("Calling MEMBERDECL ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_funcdecl, 1)) {
    ...
    if (FUNCDECL()) {
      ...
      push_node(create_subtree_n_nodes("funcdecl", 4, stack), stack);
      print_stack(stack, stack_contents);
    ...
    if (VARDECL()) {
      ...
      push_node(create_subtree_n_nodes("vardecl", 4, stack), stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting MEMBERDECL ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int MULTOP() {
  ...
  printf("Calling MULTOP ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting MULTOP ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int OPTSTRUCTDECL2() {
  ...
  printf("Calling OPTSTRUCTDECL2 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("inherits")) {
    ...
    if (match("inherits") & match("id") & REPTOPTSTRUCTDECL22()) {
      ...
      push_node(create_subtree_pop_until("inherits", "$", stack), stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting OPTSTRUCTDECL2 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int RELEXPR() {
  ...
  printf("Calling RELEXPR ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_arithexpr, 7)) {
    ...
    if (ARITHEXPR() & RELOP() & ARITHEXPR()) {
      ...
      node *relexpr = create_subtree_n_nodes("relexpr", 3, stack);
      push_node(relexpr, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting RELEXPR ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int RELOP() {
  ...
  printf("Calling RELOP ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting RELOP ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int REPT_APARAMS1() {
  ...
  printf("Calling REPT_APARAMS1 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPT_APARAMS1 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int REPTFPARAMS3() {
  ...
  printf("Calling REPTFPARARMS3 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTFPARAMS3 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int REPTFPARAMS4() {
  ...
  printf("Calling REPTFPARAMS4 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_fparamstail, 1)) {
    ...
    success = false;
  printf("Exiting REPTFPARAMS4 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int REPTFPARAMSTAIL4() {
  ...
  printf("Calling REPTFPARAMSTAIL4 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_arraysize, 1)) {
    ...
    success = false;
  printf("Exiting REPTFPARAMSTAIL4 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int VARDECLORSTAT();
int REPTFUNCBODY1() {
  printf("Calling REPTFUNCBODY1 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTFUNCBODY1 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int REPTIDNEST1() {
  ...
  printf("Calling REPTIDNEST1 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTIDNEST1 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int REPTIMPLDEF3() {
  ...
  printf("Calling REPTIMPLDEF3 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTIMPLDEF3 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int REPTOPTSTRUCTDECL22() {
  ...
  printf("Calling REPTOPTSTRUCTDECL22 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTOPTSTRUCTDECL22 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int REPTSTATBLOCK1() {
  ...
  printf("Calling REPTSTATBLOCK1 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTSTATBLOCK1 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int REPTSTRUCTDECL4() {
  ...
  printf("Calling REPTSTRUCTDECL4 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTSTRUCTDECL4 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int REPTVARDECL4() {
  ...
  printf("Calling REPTVARDECL4 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTVARDECL4 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int RIGHTRECARITHEXPR() {
  ...
  printf("Exiting RIGHTRECARITHEXPR ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_addop, 3)) {
    ...
    if (ADDOP() & TERM()) {
      ...
      node *temp = create_subtree_n_nodes("addop", 2, stack);
...
int RIGHTRECTERM() {
  ...
  printf("Calling RIGHTRECTERM ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_multop, 3)) {
    ...
    if (MULTOP() & FACTOR()) {
      ...
      node *temp = create_subtree_n_nodes("multop", 2, stack);
      temp->value = multop->value;
      print_stack(stack, stack_contents);
      push_node(temp, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting RIGHTRECTERM ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int SIGN() {
  ...
  printf("Exiting SIGN ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int STATBLOCK() {
  ...
  printf("Exiting STATBLOCK ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("lcubr")) {
    ...
    if (match("lcubr") & REPTSTATBLOCK1() & match("rcubr")) {
      ...
      node *statblock = create_subtree_pop_until("statblock", "$", stack);
      push_node(statblock, stack);
      print_stack(stack, stack_contents);
    ...
    if (STATEMENT()) {
      ...
      node *statblock = create_subtree_n_nodes("statblock", 1, stack);
      print_stack(stack, stack_contents);
      push_node(statblock, stack);
...
int STATEMENT() {
  ...
  printf("Calling STATEMENT ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("id")) {
    ...
    if (match("if") & match("lpar") & RELEXPR() & match("rpar") &
      ...
      node *ifnode = create_subtree_n_nodes("if", 3, stack);
      push_node(ifnode, stack);
      print_stack(stack, stack_contents);
    ...
    if (match("read") & match("lpar") & VARIABLE() & match("rpar") &
      ...
      node *readnode = create_subtree_n_nodes("read", 1, stack);
      push_node(readnode, stack);
      print_stack(stack, stack_contents);
    ...
    if (match("while") & match("lpar") & RELEXPR() & match("rpar") &
      ...
      node *whilenode = create_subtree_n_nodes("while", 2, stack);
      print_stack(stack, stack_contents);
      push_node(whilenode, stack);
      print_stack(stack, stack_contents);
    ...
    if (match("write") & match("lpar") & EXPR() & match("rpar") &
      ...
      node *write = create_subtree_n_nodes("write", 1, stack);
      push_node(write, stack);
      print_stack(stack, stack_contents);
    ...
    if (match("return") & match("lpar") & EXPR() & match("rpar") &
      ...
      node *returnnode = create_subtree_n_nodes("return", 1, stack);
      push_node(returnnode, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting STATEMENT ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int STATEMENTBODY() {
  printf("Calling STATEMENTBODY ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_reptidnest1, 2) || in(first_checkforendvar, 2)) {
    ...
    if (REPTIDNEST1()) {
      ...
      node *dims = create_subtree_pop_until("dimlist", "$", stack);
      print_stack(stack, stack_contents);
      push_node(dims, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting STATEMENTBODY ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int VARFUNCSTATENEST() {
  ...
  printf("Calling VARFUNCSTATENEST ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("dot")) {
    ...
    node *dot = create_subtree_n_nodes("dot", 1, stack);
    push_node(dot, stack);
  ...
  printf("Exiting VARFUNCSTATENEST ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int VARFUNCSTATENEST2() {
  ...
  printf("Calling VARFUNCSTATENEST2 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting VARFUNCSTATENEST2 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int CHECKFORENDFUNC() {
  printf("Calling CHECKFORENDFUNC ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("semi")) {
    ...
    while (strcmp(peek_stack(stack), "dot") == 0) {
      node *top = pop_node(stack);
      add_child(top, current);
      current = top;
    }

    if (strcmp(peek_stack(stack), "$") == 0) {
      node *temp = pop_node(stack);
      free(temp);
    }
  ...
  printf("Exiting CHECKFORENDFUNC ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int CHECKFORENDVAR() {
  printf("Calling CHECKFORENDVAR ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_assignop, 1)) {
    ...
    if (ASSIGNOP() & EXPR() & match("semi")) {
      ...
      node *assignop = create_subtree_n_nodes("assingop", 2, stack);
      push_node(assignop, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting CHECKFORENDVAR ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int STRUCTDECL() {
  ...
  printf("Calling STRUCTDECL ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (compare("struct")) {
    ...
    if (match("struct") & match("id") & OPTSTRUCTDECL2() & match("lcubr") &
      ...
      push_node(create_subtree_pop_until("struct", "$", stack), stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting STRUCTDECL ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int STRUCTORIMPLORFUNC() {
  ...
  printf("Calling STRUCTORIMPLORFUNC ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting STRUCTORIMPLORFUNC ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int TERM() {
  printf("Calling TERM ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting TERM ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int TYPE() {
  ...
  printf("Calling TYPE ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting TYPE ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int VARDECL() {
  ...
  printf("Calling VARDECL ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting VARDECL ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int VARDECLORSTAT() {
  ...
  printf("Calling VARDECLORSTAT ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_vardecl, 1)) {
    ...
    if (VARDECL()) {
      ...
      node *var = create_subtree_n_nodes("vardecl", 3, stack);
      push_node(var, stack);
      print_stack(stack, stack_contents);
  ...
  printf("Exiting VARDECLORSTAT ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int VARIABLE() {
  printf("Calling VARIABLE ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
...
int VARIABLE2() {
  printf("Calling VARIABLE2 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  if (in(first_reptidnest1, 1) || in(first_reptvariable, 1)) {
    ...
    if (match("lpar") & APARAMS() & match("rpar")) {
      ...
      if (match("dot") & match("id") & VARIABLE2()) {
        node *dot = create_subtree_n_nodes("dot", 2, stack);
        push_node(dot, stack);
        print_stack(stack, stack_contents);
      }
  ...
  printf("Exiting VARIABLE2 ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
 ...
 */
int REPTVARIABLE() {
  printf("Calling REPTVARIABLE ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting REPTVARIABLE ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  return success;
...
int VISIBILITY() {
  ...
  printf("Calling VISIBILITY ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
  ...
  printf("Exiting VISIBILITY ... value of success %d ... value "
         "of lookahead %s "
         "... \n",
         success, lookahead->category);
